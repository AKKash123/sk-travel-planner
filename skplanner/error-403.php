...
if (is_dir(__DIR__ . '/logs')) {
    @file_put_contents(__DIR__ . '/logs/error.log', date('Y-m-d H:i:s')." | 403 | IP:{$logIp} | URL:{$logUri}\n", FILE_APPEND);
}
?>
<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>403 Forbidden — SK Travel Planner</title>
